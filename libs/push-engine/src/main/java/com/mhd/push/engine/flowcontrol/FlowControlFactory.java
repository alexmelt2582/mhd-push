...
import com.mhd.push.domain.model.account.DingDingRobotAccount;
import com.mhd.push.domain.model.account.EnterpriseWeChatRobotAccount;
import com.mhd.push.domain.model.account.FeiShuRobotAccount;
...
public class FlowControlFactory {
    ...
    public void init() {
        ...
        leakyBucketRedisScript.setScriptSource(new ResourceScriptSource(new ClassPathResource("lua/leaky-bucket.lua")));
        log.info("FlowControlFactory#init load leaky-bucket.lua success");
    }
