package com.mhd.push.worker.receiver.rabbit;//package com.mhd.push.handler.receiver.rabbit;
//
...
//            exchange = @Exchange(value = "${mhd.rabbitmq.exchange.name}", type = ExchangeTypes.TOPIC),
//            key = "${mhd.rabbitmq.routing.send}"
//    ))
...
//            exchange = @Exchange(value = "${mhd.rabbitmq.exchange.name}", type = ExchangeTypes.TOPIC),
//            key = "${mhd.rabbitmq.routing.recall}"
//    ))
