package com.mhd.push.infra.persistence.entity;
...
public class MessageTemplate {
     ...
     * 模板内容定义 JSON。
     * <p>
     * 结构包含 content、content_params_schema、extra_params_schema 三部分。
     * </p>
     */
